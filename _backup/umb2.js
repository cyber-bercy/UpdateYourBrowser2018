try {
    ...
    */
    ...
    if (window._umb.hasOwnProperty('startDate')) {
        startDate = new Date(window._umb.startDate);
    } else {
        var startDate = new Date("1971-12");
    }
    if (window._umb.hasOwnProperty('endDate')) {
        ...
        UMB.Status = function () {
            return {
                getStatus: function () {
                    ...
                    if (b != "mobile") {
                        //not mobile
                        //filter windows xp since it is not supported if xpmode ==1
                        if ((a == "winXP") && UMB.getConfig().xpMode) {
                        ...
                        if ((a == "android") && (UMB.getConfig().androidMode) && (UMB.Detect.OSVersion < 4)) {
            ...
            var c = !1,
                ...
                e = function () {
                    ...
                    if (d && b && c) {
                        ...
                        switch (d) {
                            case "latest":
                                f = "Vous avez installé la dernière version disponible de " + b.name + " . ", k.style.color = updateColor, k.appendChild(document.createTextNode("Learn more"));
                                break;
                            case "update":
                                f = "Une mise à jour de (" + b.name + " " + b.current + ") est disponible. Veuillez ", k.style.color = linkColor, k.appendChild(document.createTextNode("installer cette mise à jour")), l = ".";
                                break;
                            case "warning":
                            ...
                            case "updateOs":
                                ...
                                f = "Votre système d'exploitation ne dispose plus de mise à jour de sécurité, vos informations sont en dangers.", k.style.color = updateColor, k.appendChild(document.createTextNode("Plus d'informations"));
                                break;
                            case "androidDeprecated":
                                f = "Votre système d'exploitation Android ne dispose plus de mise à jour de sécurité.", k.style.color = linkColor, k.appendChild(document.createTextNode("Plus d'informations")), l = ".";
                                break;
                            case "warning2":
                                f = "Une mise à jour importante de sécurité de " + b.name + "  est disponible. Veuillez ", k.style.color = linkColor, k.appendChild(document.createTextNode("installer ce correctif critique")), l = ".", a = !0;
                                break;
